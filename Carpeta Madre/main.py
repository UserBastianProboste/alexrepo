...
from ProyectoGenealogiaChile import*;
from genealogia_chile_output import*;
...
class GenealogiaDB:
	...
	def insertar_familia(self,familia):
		"""Inserta una familia en la base de datos.familia: dict 
	con la estructura {'nombre': str, fundador': str, 'descendientes': list}"""
